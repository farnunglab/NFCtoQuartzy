...
# NFCtoQuartzy
A workflow that lets lab members reorder common lab supplies from Quartzy by tapping an NFC tag (or scanning a QR code). The workflow makes use of Cloudflare Worker.
